/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2949479cb326d5ad783d4e1654c055b)
// Runtime types generated with workerd@1.20251213.0 2025-12-13 no_nodejs_compat_v2,nodejs_compat
...
type LoopbackServiceStub<T extends Rpc.WorkerEntrypointBranded | undefined = undefined> = Fetcher<T> & (T extends CloudflareWorkersModule.WorkerEntrypoint<any, infer Props> ? (opts: { props?: Props }) => Fetcher<T> : (opts: { props?: any }) => Fetcher<T>);
type LoopbackDurableObjectClass<T extends Rpc.DurableObjectBranded | undefined = undefined> = DurableObjectClass<T> & (T extends CloudflareWorkersModule.DurableObject<any, infer Props> ? (opts: { props?: Props }) => DurableObjectClass<T> : (opts: { props?: any }) => DurableObjectClass<T>);
